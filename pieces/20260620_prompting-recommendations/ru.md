...
Противовес от практиков остужает ожидания: экономия по всей сессии чаще выходит ~4–10%, и [часть заявленного не доживает до счёта за токены](https://medium.com/hecatus-research/less-is-more-for-llms-a-critique-of-prompt-based-compression-910978d8bad4).
