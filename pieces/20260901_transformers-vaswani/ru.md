...
Диагноз в [статье](https://arxiv.org/abs/1409.0473) сформулирован без обиняков: *«вектор фиксированной длины — это бутылочное горлышко»*. Длинное предложение туда попросту не влезает — и всё, что не поместилось, теряется. Полработы в науке — верно назвать болезнь. Тут её назвали — и стало ясно, что чинить.
