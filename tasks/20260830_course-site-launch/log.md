...
- ⚠ **Деплой не выполнен: нет SSH-ключа к RU VPS 88.218.62.36** (прошлый жил в scratchpad и
  утерян, `~/.ssh` пуст). Сгенерирован новый ed25519, публичная часть отдана владельцу.
