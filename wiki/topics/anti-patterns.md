...
| "More GitHub stars = safer / higher-quality repo" | Stars measure hype, not safety or upkeep. Cleanest audited repo had 244k stars; the repo with the security defect had 2.2k; a clean, active personal collection had 301. Stars and marketing counts ("1000+", real ≈ 30–40) both inflate. | [claude-skills-collections](../pieces/INDEX.md) (2026-07-02, audit of 7 skills repos) | 2026-07-02 |
| "npm packages under an `@anthropic`-looking scope are official" | The real Anthropic scope is `@anthropic-ai` (`@anthropic-ai/sdk`, `@anthropic-ai/claude-code`). A repo's MCP configs referenced `@anthropic/mcp-ghidra`, `@anthropic/mcp-figma`, etc. — all 404, a plausible-but-unclaimed look-alike scope. Latent namespace-squatting: LLM-hallucinated package names under an official-looking-but-unowned scope. Verify every package with `npm info` before install. | [claude-skills-collections](../pieces/INDEX.md) (2026-07-02, rohitg00 toolkit finding) | 2026-07-02 |
